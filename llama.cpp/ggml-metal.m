...
void ggml_backend_metal_get_device_properties(ggml_backend_t backend, struct ggml_metal_device_properties * properties) {
    ...
    // properties->max_threads_per_threadgroup = ctx->device.maxThreadsPerThreadgroup;
    // properties->max_threadgroup_memory_length = ctx->device.maxThreadgroupMemoryLength;
    // properties->max_buffer_length = ctx->device.maxBufferLength;
